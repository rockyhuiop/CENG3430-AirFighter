...
HD_PWD='C:/Users/Student/Documents/Rocky/proj/AirFighter/CENG3430-AirFighter/AirFighter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AirFighter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AirFighter.tcl
